...
<head>
    ...
    <meta name="description" content="Inicia sesión en IMAGUESS para guardar tus puntuaciones y competir en el ranking global de reconocimiento de imágenes.">
...
<body>
    ...
    <div style="position:relative;z-index:10;" class="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div class="terminal-box w-full max-w-sm p-8" style="position:relative;">
            ...
            @if(session('error'))
            <div style="border:1px solid var(--red); color:var(--red); padding:8px; font-size:0.75rem; margin-bottom:16px; letter-spacing:1px;">
                [ERR] {{ session('error') }}
            </div>
            @endif
